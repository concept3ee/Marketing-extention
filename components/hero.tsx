      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            Empowering Startups to Launch,  <span className="text-primary italic">Scale, and Succeed Faster</span>
            </h1>
            
            <p className="text-xl text-white/60 mb-10 max-w-lg leading-relaxed">
            From MVP to market domination – your reliable partner in design and development.
